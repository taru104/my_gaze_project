...
16Dも同梱し自己完結で公平比較。GPU不要。mainは触らない。 出力: cache/mpii_app3.npz X16, Xhi, y, pid
...
def main():
    ...
    lm = make_lm(); ck = ROOT / "cache" / "mpii_app3_ck.npz"
    ...
    out = ROOT / "cache" / ("mpii_app3_test.npz" if "--test" in sys.argv else "mpii_app3.npz")
